/**
 * Note: This is a copy of the Arduino class "HttpClient"
 * modified to accommodate a larger buffer size
 * and allow a delay of larger than 5 seconds with the server.
 */
#ifndef __HTTP_CLIENT_LARGE_H_
#define __HTTP_CLIENT_LARGE_H_
